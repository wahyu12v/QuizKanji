...
function hiraToRomaji(hira){
  ...
  const yoon = {きゃ:'kya',きゅ:'kyu',きょ:'kyo',しゃ:'sha',しゅ:'shu',しょ:'sho',ちゃ:'cha',ちゅ:'chu',ちょ:'cho',
  ...
  const base = {あ:'a',い:'i',う:'u',え:'e',お:'o',か:'ka',き:'ki',く:'ku',け:'ke',こ:'ko',が:'ga',ぎ:'gi',ぐ:'gu',げ:'ge',ご:'go',
  ...
  for(let i=0;i<hira.length;i++){
    ...
    if(ch === 'ー'){ const last = out.slice(-1); if('aiueo'.includes(last)) out += last; continue; }
  }
  return out;
}
